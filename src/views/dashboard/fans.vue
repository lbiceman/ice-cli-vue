...
const statsData = ref([
	{ title: "粉丝总数", value: 56789, icon: "ice-icon-user", color: "#66BBFF" },
	{ title: "今日新增", value: 234, icon: "ice-icon-computer", color: "#60D36E" },
	{ title: "活跃粉丝", value: 12345, icon: "ice-icon-home", color: "#E7CF48" },
	{ title: "取关人数", value: 56, icon: "ice-icon-warning", color: "#FE5643" }
]);
</script>

<template>
	<div class="dashboard-fans">
		<!-- 统计卡片 -->
