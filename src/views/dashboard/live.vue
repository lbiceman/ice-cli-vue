...
const statsData = ref([
	{ title: "直播场次", value: 123, icon: "ice-icon-user", color: "#66BBFF" },
	{ title: "今日直播", value: 5, icon: "ice-icon-computer", color: "#60D36E" },
	{ title: "观看人次", value: 87654, icon: "ice-icon-home", color: "#E7CF48" },
	{ title: "互动次数", value: 43210, icon: "ice-icon-warning", color: "#FE5643" }
]);
</script>
